...
public class PptSplitter implements Serializable {
  ...
  private void add_implications_pair() {
    ...
    for (VarInfo[] vis : slices) {
      ...
      List</*@KeyFor("orig_invs")*/ Invariant /*@ArrayLen(2)*/[]> ec =
      ...
      @SuppressWarnings("keyfor") // need qualifier parameter to Invariants
      List</*@Nullable*//*@KeyFor("orig_invs")*/ Invariant /*@ArrayLen(2)*/[]> di =
   ...
   */
  List<Invariant /*@ArrayLen(2)*/[]> exclusive_conditions(
   ...
   * program point.
   */
  List</*@Nullable*/ Invariant /*@ArrayLen(2)*/[]> different_invariants(
      List<Invariant> invs1, List<Invariant> invs2) {
